...
CUDA_VISIBLE_DEVICES=2 python train_with_coarse.py \
    ...
    --exp_name 'imagenet_90new_simgcd(DoubleCoarseClusterContrastiveSupcontrastiveCoarse)_coarsenum(10)_weight(warmup_30-60_0.0-0.0_cooloff_120-150_0.0-0.0)_dcweight(0.0-0.0)_fineweight(dynamic)_batchsz(128)'
# CUDA_VISIBLE_DEVICES=3 python train.py \
#     --dataset_name 'cifar100' \
#     --setting 'default' \
#     --batch_size 128 \
