...
CUDA_VISIBLE_DEVICES=2 python train_with_coarse.py \
    ...
    --warmup_coarse_weight_end_epoch 80 \
    --coarse_weight 0.5 \
    ...
    --exp_name 'cifar100small_default_twohead(GtclsSupclsmqsoftClusterContrastiveSupcontrastiveCoarse)_weight(warmup_30-60_0.0-0.5_cooloff_120-150_0.5-0.2)_fineweight(dynamic)_batchsz(256)_SEED2'
