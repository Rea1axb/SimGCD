...
CUDA_VISIBLE_DEVICES=3 python train_with_coarse.py \
    ...
    --exp_name 'cifar100small_default_twohead(DoubleCoarsePrototypesSupclsmqsoftClusterContrastiveSupcontrastiveCoarse)_weight(warmup_30-60_0.0-0.5_cooloff_120-150_0.5-0.5)_fineweight(dynamic)_batchsz(256)'
