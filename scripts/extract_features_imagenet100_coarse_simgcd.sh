...
CUDA_VISIBLE_DEVICES=2 python extract_features.py \
    ...
    --warmup_model_dir '/home/czq/workspace/GCD/SimGCD/outputs/simgcd/log/imagenet/imagenet_30new_simgcd(DoubleCoarseClusterContrastiveSupcontrastiveCoarse)_coarsenum(10)_weight(warmup_30-60_0.0-0.0_cooloff_120-150_0.0-0.0)_dcweight(0.0-0.0)_fineweight(dynamic)_batchsz(128)_(19.09.2024_|_35.139)/checkpoints/model_200.pt'\
    --exp_name 'imagenet_default_simgcd_imagenet_(19.09.2024_|_35.139)_200'
